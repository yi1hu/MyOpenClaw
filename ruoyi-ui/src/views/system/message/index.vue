  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="留言状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择留言状态" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="messageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="留言内容" align="center" prop="messageContent" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="留言内容" prop="messageContent">
          <el-input v-model="form.messageContent" type="textarea" placeholder="请输入留言内容" />
        </el-form-item>
